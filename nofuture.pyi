...
class MayBe(Generic[T]):
    ...
    def match(
        self,
        just: Callable[[T], U] | None = None,
        nothing: Callable[[], U] | None = None,
    ) -> U | None: ...
...
class Result(Generic[T, E]):
    ...
    def match(
        ...
        err: Callable[[str, str | None, Any | None], U] | None = None,
    ) -> U | None: ...
    ...
    def map_err(
        self,
        fn: Callable[[str, str | None, Any | None], tuple[str, str | None, Any | None]],
    ) -> "Result[T, E]": ...
